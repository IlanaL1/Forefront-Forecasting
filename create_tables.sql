...
INSERT INTO "paramTable1" VALUES ('SMOOTH',0);
...
INSERT INTO "paramTable2" VALUES ('SMOOTH',0);
...
INSERT INTO "paramTable3" VALUES ('SMOOTH',0);
INSERT INTO "paramTable3" VALUES ('NUM_VAR',0); 
INSERT INTO "paramTable3" VALUES ('FREQUENCY',261); #not used
INSERT INTO "paramTable3" VALUES ('FREQUENCY_TYPE',2);
INSERT INTO "paramTable3" VALUES ('HOLIDAY',1); #not used

DROP TABLE "paramTable4";
CREATE COLUMN TABLE "paramTable4" LIKE "param_model" WITH NO DATA;
--INSERT into "paramTable" VALUES (1,365,1);
INSERT INTO "paramTable4" VALUES ('HORIZON',30);
INSERT INTO "paramTable4" VALUES ('SMOOTH',0);
INSERT INTO "paramTable4" VALUES ('NUM_VAR',1); 
INSERT INTO "paramTable4" VALUES ('FREQUENCY',261); #not used
INSERT INTO "paramTable4" VALUES ('FREQUENCY_TYPE',2);
INSERT INTO "paramTable4" VALUES ('HOLIDAY',1); #not used

DROP TABLE "paramTable5";
-- no variables
CREATE COLUMN TABLE "paramTable5" LIKE "param_model" WITH NO DATA;
INSERT INTO "paramTable5" VALUES ('HORIZON',30);
INSERT INTO "paramTable5" VALUES ('SMOOTH',0);
INSERT INTO "paramTable5" VALUES ('NUM_VAR',0); 
INSERT INTO "paramTable5" VALUES ('FREQUENCY',12);
INSERT INTO "paramTable5" VALUES ('FREQUENCY_TYPE',4);
INSERT INTO "paramTable5" VALUES ('HOLIDAY',1);
...
DROP TABLE "DS3";
CREATE TABLE "DS3" as (SELECT "Date" as DATE_ID, "WaterUsage" as TOTAL FROM "DS03_Monthly_Water_Usage_London2");
SELECT * FROM "DS3";
